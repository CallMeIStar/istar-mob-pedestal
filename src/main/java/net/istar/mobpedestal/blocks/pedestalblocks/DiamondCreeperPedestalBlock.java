...
public class DiamondCreeperPedestalBlock extends MobPedestalBlock {
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public DiamondCreeperPedestalBlock(Settings settings) {
        super(settings, MobType.CREEPER, 64);
