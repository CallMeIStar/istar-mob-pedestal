...
public class DiamondEndermanPedestalBlock extends MobPedestalBlock {
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public DiamondEndermanPedestalBlock(Settings settings) {
        super(settings, MobType.ENDERMAN, 64);
