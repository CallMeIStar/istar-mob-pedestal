...
public class DiamondPhantomPedestalBlock extends MobPedestalBlock {
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public DiamondPhantomPedestalBlock(Settings settings) {
        super(settings, MobType.PHANTOM, 64);
