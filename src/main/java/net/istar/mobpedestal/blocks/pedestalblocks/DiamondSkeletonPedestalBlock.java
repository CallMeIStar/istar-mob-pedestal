...
public class DiamondSkeletonPedestalBlock extends MobPedestalBlock {
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public DiamondSkeletonPedestalBlock(Settings settings) {
        super(settings, MobType.SKELETON, 64);
