...
public class NetheriteEndermanPedestalBlock extends MobPedestalBlock {
    public static final BooleanProperty ACTIVE = BooleanProperty.of("active");
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public NetheriteEndermanPedestalBlock(Settings settings) {
        super(settings, MobType.ENDERMAN, 128);
