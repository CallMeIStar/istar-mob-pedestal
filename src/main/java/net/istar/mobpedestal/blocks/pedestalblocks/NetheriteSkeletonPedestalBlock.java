...
public class NetheriteSkeletonPedestalBlock extends MobPedestalBlock {
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public NetheriteSkeletonPedestalBlock(Settings settings) {
        super(settings, MobType.SKELETON, 128);
