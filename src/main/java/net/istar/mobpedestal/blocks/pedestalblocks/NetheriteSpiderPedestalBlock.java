...
public class NetheriteSpiderPedestalBlock extends MobPedestalBlock {
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public NetheriteSpiderPedestalBlock(Settings settings) {
        super(settings, MobType.SPIDER, 128);
