...
public class NetheriteZombiePedestalBlock extends MobPedestalBlock {
    private static final VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 12, 14, 12);

    public NetheriteZombiePedestalBlock(Settings settings) {
        super(settings, MobType.ZOMBIE, 128);
